...
function DashboardScreen() {
    ...
    const dummyData = formattedData?.map((item)=>item + ((Math.random()*100)+ 1 ));
    const graph_data = {
        labels: rowLabel,
        datasets: [
            {
    ...
    const dummygraph = formatData?.map((item)=> item + ((Math.random()* 100)+ 1))
    const graph = {
        labels: rowLabel,
        datasets: [
            {
            ...
            <div className="flex flex-wrap items-center">
                ...
                <div class="container px-5 py-24 mx-auto bg-white">
                    <div class="flex flex-wrap -m-4">
                        ...
                        <div class="p-4 sm:w-1/4 w-1/2 border-r-2 border-gray-300">
                            <h2 class="title-font font-medium text-3xl text-gray-900">{apiInfo && apiInfo.link_clicked + 50}</h2>
                            <div className='flex flex-inline flex-row justify-between'>
                        ...
                        <div class="p-4 sm:w-1/4 w-1/2 border-r-2 border-gray-300">
                            <h2 class="title-font font-medium text-3xl text-gray-900">{apiInfo && apiInfo.active_users + 59}</h2>
                            <div className='flex flex-inline flex-row justify-between'>
                        ...
                        <div class="p-4 sm:w-1/4 w-1/2">
                            <h2 class="title-font font-medium text-3xl text-gray-900">{apiInfo && apiInfo.earnings + 70}</h2>
                            <div className='flex flex-inline flex-row justify-between'>
